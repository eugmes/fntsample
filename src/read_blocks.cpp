...
{
    int nalloc = 256;
    struct unicode_block *blocks = (struct unicode_block *)calloc(nalloc, sizeof(struct unicode_block));
    *n = 0;
            ...
            *n += 1;
            if (*n >= nalloc) {
                ...
                struct unicode_block *new_blocks =
                    (struct unicode_block *)realloc(blocks,
    ...
    if (*n == 0) {
        ...
        blocks = (struct unicode_block *)realloc(blocks, *n * sizeof(struct unicode_block));
    }
